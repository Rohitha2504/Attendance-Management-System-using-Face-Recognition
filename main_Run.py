    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = r'C:\Users\rohit\Downloads\attendenceedunet\Attendance\Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\rohit\Downloads\attendenceedunet\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='rohitha@1', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = r'C:\Users\rohit\Downloads\attendenceedunet\Attendance\Manually Attendance' + DB_table_name + '.csv'
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,C:\Users\rohit\Downloads\attendenceedunet\Attendance\-------Check atttendance-------')
    ...
    def log_in():
        ...
        if username == 'shiva':
            if password == 'shiva123':
                ...
                cs =r'C:\Users\rohit\Downloads\attendenceedunet\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
